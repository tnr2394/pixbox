...
jQuery.fn.pixbox = function(){
	$(this).append('<div id="imgHolder" class="parent" style=""><button id="viewer-img-zoom-in" >+</button><button id="viewer-img-zoom-out">-</button><button id="viewer-img-close">x</button><img draggable="true" id="previewImg" class="child ui-resizable" ><h4 id="captionHolder" style=""></h4><button id="viewer-img-rotate" > &cudarrr;</button><button id="viewer-img-nxt" >&#10140;</button><button id="viewer-img-prev" style="transform: rotate(180deg); padding-bottom: 7px">&#10140;</button><ul id="viewer-img-reel"></ul></div>');
...
$(window).on('keydown',function(e){
	if(!isOpen) return;
	if(e.which == 39 && e.shiftKey){doRotate();return;}
	if(e.which == 39) next();
